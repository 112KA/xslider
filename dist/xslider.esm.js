...
prototypeAccessors.x.get = function () { return this.data[0]; };
prototypeAccessors.y.get = function () { return this.data[1]; };

prototypeAccessors.x.set = function (v) { this.data[0] = v; };
prototypeAccessors.y.set = function (v) { this.data[1] = v; };
...
prototypeAccessors$1.x.get = function () { return this.data[0]; };
prototypeAccessors$1.y.get = function () { return this.data[1]; };
prototypeAccessors$1.z.get = function () { return this.data[2]; };

prototypeAccessors$1.x.set = function (v) { this.data[0] = v; };
prototypeAccessors$1.y.set = function (v) { this.data[1] = v; };
prototypeAccessors$1.z.set = function (v) { this.data[2] = v; };
...
prototypeAccessors$2.x.get = function () { return this.data[0]; };
prototypeAccessors$2.y.get = function () { return this.data[1]; };
prototypeAccessors$2.z.get = function () { return this.data[2]; };
prototypeAccessors$2.w.get = function () { return this.data[3]; };

prototypeAccessors$2.x.set = function (v) { this.data[0] = v; };
prototypeAccessors$2.y.set = function (v) { this.data[1] = v; };
prototypeAccessors$2.z.set = function (v) { this.data[2] = v; };
prototypeAccessors$2.w.set = function (v) { this.data[3] = v; };
	...
	Ticker.prototype._defineFunctions = function _defineFunctions () {
		...
		this._tickHandler = function () {
			...
			if(overlap >= 0) {
				...
				this$1.dispatch('tick', {type:'tick', time:this$1._lastMs - this$1._startMs, dt:this$1._nextMs-t0});
			}
		};
	};
...
Cloner.prototype.copyStyle = function copyStyle (original, target, excludes) {
	...
	if(original.cssText) {
		...
		for(var i$1=0; i$1<original.length; i$1++) {
			...
			target.setProperty(name$1, original.getPropertyValue(name$1), original.getPropertyPriority(name$1));
		}
	}
	...
	resolveFonts: function resolveFonts() {
		...
		return new Promise(function (resolve, reject) {
			if(this$1.inlinedFontString) {
				...
				this$1.inlineFonts(fontStrings)
					.then(function (inlinedFontStrings) {
...
var SlideContainer = /*@__PURE__*/(function (EventDispatcher) {
	...
	SlideContainer.prototype.updateSlide = function updateSlide (slideIndex) {
		...
		return new Promise(function (resolve, reject) {
			...
			slide.resize(this$1.width, this$1.height)
				.then(function () {
					if(this$1.uniforms) {
						var texture = this$1.uniforms['texture'+slideIndex].value;
...
var Indexer = /*@__PURE__*/(function (EventDispatcher) {
	...
	Indexer.prototype.to = function to (index) {
		if(this.data.option.loop) {
			var d0 = index - this.current, d1, diff;
...
var SlideController = /*@__PURE__*/(function (EventDispatcher) {
	...
	SlideController.prototype._defineHandlers = function _defineHandlers () {
		...
		this._onResize = function (e) {
			var w = this$1.dom.width, h = this$1.dom.height;
		...
		this._onTick = function (e) {
			...
			this$1.container.ready(this$1.indexer)
				.then(function () {
					this$1.renderer.gl.render(this$1.indexer);
				},
				function (message) {
		...
		this._onChange = function (e) {
			switch(e.type) {
				...
				case 'index':
					...
					this$1.container.ready(this$1.indexer).then(function () {
